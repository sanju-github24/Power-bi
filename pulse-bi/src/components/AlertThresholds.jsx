...
const s = {
  ...
  header:   { display:'flex', alignItems:'center', justifyContent:'space-between', padding:'.65rem .9rem', cursor:'pointer' },
  label:    { display:'flex', alignItems:'center', gap:'.4rem', fontSize:'.59rem', fontFamily:"'JetBrains Mono',monospace", textTransform:'uppercase', letterSpacing:'.13em', color:'var(--muted)' },
  chevron:  { fontSize:'.55rem', color:'var(--muted)' },
  trigBadge:{ background:'rgba(255,107,107,.18)', color:'#ff8a8a', fontSize:'.58rem', borderRadius:999, padding:'.05rem .35rem', fontWeight:700 },
  triggered:{ margin:'.0 .6rem .4rem', padding:'.45rem .6rem', background:'rgba(255,107,107,.07)', border:'1px solid rgba(255,107,107,.25)', borderRadius:7, fontSize:'.72rem', color:'#ff9a9a', display:'flex', alignItems:'center', gap:'.4rem', flexWrap:'wrap' },
  investigateBtn:{ marginLeft:'auto', background:'none', border:'1px solid rgba(255,107,107,.3)', borderRadius:5, color:'#ff8a8a', fontSize:'.62rem', padding:'.15rem .45rem', cursor:'pointer', fontFamily:"'JetBrains Mono',monospace", whiteSpace:'nowrap' },
  body:     { padding:'.0 .75rem .65rem' },
  inputRow: { display:'flex', gap:'.35rem', marginBottom:'.3rem' },
  input:    { flex:1, background:'var(--s3)', border:'1px solid var(--border2)', borderRadius:6, color:'var(--text)', fontFamily:"'Figtree',sans-serif", fontSize:'.72rem', padding:'.3rem .55rem', outline:'none' },
  addBtn:   { background:'var(--accent)', color:'#000', border:'none', borderRadius:6, width:28, fontWeight:700, fontSize:'.9rem', cursor:'pointer' },
  hint:     { fontSize:'.6rem', color:'var(--muted)', fontFamily:"'JetBrains Mono',monospace", marginBottom:'.5rem', fontStyle:'italic' },
  ...
  alertText:{ fontSize:'.68rem', color:'var(--muted2)', fontFamily:"'JetBrains Mono',monospace" },
  delBtn:   { background:'none', border:'none', color:'var(--muted)', fontSize:'.7rem', cursor:'pointer', padding:'.1rem .2rem' },
  empty:    { fontSize:'.65rem', color:'var(--muted)', fontStyle:'italic', textAlign:'center', padding:'.4rem 0' },
}
