...
const s = {
  ...
  hints:   { display: 'flex', gap: '.72rem', marginTop: '.35rem' },
  hint:    { fontSize: '.72rem', fontFamily: "'JetBrains Mono',monospace", color: 'var(--muted)', background: 'var(--s3)', border: '1px solid var(--border)', borderRadius: 4, padding: '.08rem .32rem' },
  chips:   { display: 'flex', gap: '.3rem', flexWrap: 'wrap', marginTop: '.5rem' },
  chip:    { fontSize: '.76rem', fontFamily: "'JetBrains Mono',monospace", background: 'var(--s2)', border: '1px solid var(--border2)', borderRadius: 999, padding: '.18rem .72rem', color: 'var(--muted2)', cursor: 'pointer', transition: 'all .15s' },
  fuChip:  { borderColor: 'rgba(180,142,255,.3)', color: 'var(--accent4)' },
  progress:{ height: 2, marginTop: '.72rem', background: 'linear-gradient(90deg,var(--accent),var(--accent2),var(--accent4),var(--accent))', backgroundSize: '300%', animation: 'sweep 1.4s linear infinite', borderRadius: 1 },
}