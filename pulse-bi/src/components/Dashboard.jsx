...
const s = {
  empty:        { display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', height:'100%', gap:'.7rem', color:'var(--muted)', textAlign:'center', padding:'2rem' },
  ...
  cannotAnswer: { display:'flex', alignItems:'flex-start', gap:'.65rem', padding:'1.1rem', margin:'1.1rem', background:'rgba(255,107,107,.05)', border:'1px solid rgba(255,107,107,.18)', borderRadius:11 },
  ...
  fuBanner:     { display:'inline-flex', alignItems:'center', gap:'.45rem', marginBottom:'.8rem', fontSize:'.67rem', fontFamily:"'JetBrains Mono',monospace", background:'rgba(180,142,255,.07)', color:'var(--accent4)', border:'1px solid rgba(180,142,255,.18)', borderRadius:999, padding:'.26rem .72rem' },
  ...
  querySpeed:   { fontSize:'.62rem', fontFamily:"'JetBrains Mono',monospace", color:'rgba(74,222,128,.7)' },
  ...
  tldrHead:     { display:'flex', alignItems:'center', gap:'.4rem', marginBottom:'.55rem' },
  tldrIcon:     { fontSize:'.85rem', color:'var(--accent)' },
  tldrLabel:    { fontSize:'.6rem', fontFamily:"'JetBrains Mono',monospace", textTransform:'uppercase', letterSpacing:'.14em', color:'rgba(232,255,71,.7)' },
  tldrItems:    { display:'flex', flexDirection:'column', gap:'.35rem' },
  tldrItem:     { display:'flex', alignItems:'flex-start', gap:'.55rem' },
