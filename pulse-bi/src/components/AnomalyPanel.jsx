...
function Stat({ label, value }) {
  return (
    <div style={{ textAlign: 'center' }}>
      <div style={{ fontSize: '.75rem', color: 'var(--muted)', fontFamily: "'JetBrains Mono',monospace", textTransform: 'uppercase', letterSpacing: '.08em' }}>{label}</div>
...
const s = {
  ...
  header:     { display: 'flex', alignItems: 'center', justifyContent: 'space-between', cursor: 'pointer', marginBottom: '.72rem' },
  sectionLabel:{ fontSize: '.72rem', fontFamily: "'JetBrains Mono',monospace", textTransform: 'uppercase', letterSpacing: '.13em', color: 'var(--muted)' },
  badges:     { display: 'flex', alignItems: 'center', gap: '.3rem' },
  badge:      { fontSize: '.72rem', fontFamily: "'JetBrains Mono',monospace", borderRadius: 999, padding: '.1rem .38rem', fontWeight: 600 },
  chevron:    { fontSize: '.72rem', color: 'var(--muted)', fontFamily: "'JetBrains Mono',monospace" },
  clean:      { fontSize: '.78rem', color: 'var(--success)', fontFamily: "'JetBrains Mono',monospace" },
  list:       { display: 'flex', flexDirection: 'column', gap: '.35rem' },
  card:       { border: '1px solid', borderRadius: 8, overflow: 'hidden', transition: 'all .2s' },
  cardTop:    { display: 'flex', alignItems: 'center', gap: '.45rem', padding: '.45rem .75rem', cursor: 'pointer' },
  ...
  typeLabel:  { fontSize: '.75rem', fontFamily: "'JetBrains Mono',monospace", marginTop: '.08rem' },
  detail:     { padding: '.45rem .75rem .72rem', borderTop: '1px solid rgba(255,255,255,.05)', display: 'flex', flexDirection: 'column', gap: '.35rem' },
  statRow:    { display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '.3rem', background: 'rgba(0,0,0,.2)', borderRadius: 6, padding: '.4rem' },
  flag:       { fontSize: '.78rem', fontFamily: "'JetBrains Mono',monospace", color: 'var(--muted2)' },
  sampleLabel:{ fontSize: '.72rem', color: 'var(--muted)', fontFamily: "'JetBrains Mono',monospace", textTransform: 'uppercase', letterSpacing: '.1em' },
  samples:    { display: 'flex', flexWrap: 'wrap', gap: '.25rem' },
  sampleVal:  { fontSize: '.76rem', fontFamily: "'JetBrains Mono',monospace", background: 'rgba(0,0,0,.3)', borderRadius: 4, padding: '.1rem .35rem' },
  askBtn:     { background: 'none', border: '1px solid', borderRadius: 6, padding: '.35rem .75rem', fontSize: '.76rem', fontFamily: "'JetBrains Mono',monospace", cursor: 'pointer', width: '100%', marginTop: '.1rem', textAlign: 'left', transition: 'background .15s' },
}
