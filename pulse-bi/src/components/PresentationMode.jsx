...
const s = {
  ...
  kbd:     { background: 'var(--s3)', border: '1px solid var(--border2)', borderRadius: 3, padding: '.05rem .3rem', fontSize: '.65rem' },
  ...
  footerText:{ fontSize: '.65rem', fontFamily: "'JetBrains Mono',monospace", color: 'var(--muted)' },
}
